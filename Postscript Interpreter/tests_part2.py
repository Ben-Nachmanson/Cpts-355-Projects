...
class HW4GradingTests(unittest.TestCase):
    ...
    def test_input3(self):
        testinput3 = """
            ...
            (123456)  f
        """
        opstackOutput = [ArrayConstant([1, 2, StrConstant('(322)'), 3]), ArrayConstant([
            1, -2, 9, 4]), StrConstant('(123456)'), 6]
        ...
        for i in range(0, len(opstackOutput)):
            self.assertTrue(self.compareObjectData(
                self.psstacks.opstack[i], opstackOutput[i]))
    ...
    def test_input11(self):
        testinput11 = """
            ...
            lt
        """
        opstackOutput = [ArrayConstant([49, 50, 51, 52, 53, 54]), ArrayConstant([49, 50, 51, 52, 100, 54]), ArrayConstant(
            [49, 50, 51, 52, 100, 54]), StrConstant('(12345)'), StrConstant('(1234d)'), StrConstant('(1234d)'), False]
...
"""
    ...
    def test_input14(self):
        ...
        """
        opstackOutput = [StrConstant('(or)'), False, FunctionBody([StringExpr('(Easy)'), Name(
            'eq'), CodeArray([StringExpr('(n)')]), CodeArray([StringExpr('(t)')]), Name('ifelse')])]
    ...
    def test_input15(self):
        ...
        """
        opstackOutput = [10, 20, 90, 40, 50, 10, 20, 90, 40, 50, False]
